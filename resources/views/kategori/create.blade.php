...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Tambah Kategori Mustahik</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('kategori.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control @error('jumlah_hak') is-invalid @enderror" id="jumlah_hak" name="jumlah_hak" value="{{ old('jumlah_hak') }}" required>
                @error('jumlah_hak')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
